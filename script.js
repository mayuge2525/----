...
const svgData = {
    ...
    'stage-baby': {
        main: baseBodyPath,
        mainColor: '#81c784', // 画像に近い緑
        sub: '',
        subColor: 'transparent',
        eyes: baseEyes + baseCheeks
    },
    'fire': {
        child: {
            main: baseBodyPath,
            mainColor: '#ffab91',
            sub: 'M100,60 Q100,40 110,35 Q120,40 120,60 Z', // 小さな炎のトサカ
            subColor: '#ff7043',
            eyes: baseEyes + baseCheeks
        },
        adult: {
            main: baseBodyPath,
            mainColor: '#ff7043',
            sub: 'M90,60 Q90,30 105,20 Q120,30 120,60 M110,60 Q110,35 125,30 Q140,35 140,60 Z', // 立派な炎
            subColor: '#d84315',
            eyes: baseEyes + baseCheeks
        }
    },
    'water': {
        child: {
            main: baseBodyPath,
            mainColor: '#81d4fa',
            sub: 'M150,130 Q165,130 170,140 Q165,150 150,150 Z', // 小さなヒレ
            subColor: '#4fc3f7',
            eyes: baseEyes + baseCheeks
        },
        adult: {
            main: baseBodyPath,
            mainColor: '#4fc3f7',
            sub: 'M150,120 Q180,120 185,135 Q180,155 150,150 M100,60 Q100,40 115,35 Q130,40 130,60 Z', // 大きなヒレとトサカ
            subColor: '#0288d1',
            eyes: baseEyes + baseCheeks
        }
    },
    'wind': {
        child: {
            main: baseBodyPath,
            mainColor: '#e0e0e0',
            sub: 'M50,110 Q35,110 30,120 Q35,130 50,130 Z', // 小さなはね
            subColor: '#bdbdbd',
            eyes: baseEyes + baseCheeks
        },
        adult: {
            main: baseBodyPath,
            mainColor: '#bdbdbd',
            sub: 'M50,100 Q20,100 15,115 Q20,135 50,130 M150,100 Q180,100 185,115 Q180,135 150,130 Z', // 大きなはね
            subColor: '#9e9e9e',
            eyes: baseEyes + baseCheeks
        }
    },
    'earth': {
        child: {
            main: baseBodyPath,
            mainColor: '#aed581',
            sub: 'M80,65 L85,45 L95,62 M105,62 L115,45 L120,65 Z', // 小さな角
            subColor: '#f5f5f5',
            eyes: baseEyes + baseCheeks
        },
        adult: {
            main: baseBodyPath,
            mainColor: '#7cb342',
            sub: 'M70,70 L75,30 L95,65 M105,65 L125,30 L130,70 M100,60 Q100,30 130,30 Q160,30 160,60 Z', // 立派な角とフリル
            subColor: '#e0e0e0',
            eyes: baseEyes + baseCheeks
        }
    }
...
function updateDinoSVG(stage, attr) {
    ...
    if (data) {
        ...
        // 大人の場合は少し大きく
        if (stage.includes('adult')) {
            dinoElement.style.transform = 'scale(1.2)';
        } else if (stage === 'stage-baby') {
            dinoElement.style.transform = 'scale(0.8)';
        } else {
            dinoElement.style.transform = 'scale(1)';
        }
    }
}
